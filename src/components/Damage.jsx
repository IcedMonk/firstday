    ...
    <>
      ...
      >
        <Flex justify="space-between" align="center" p={3}>
          ...
          <chakra.h3 fontSize="4xl" fontWeight="bold" mr={12}>
            Damaged Products
          </chakra.h3>
